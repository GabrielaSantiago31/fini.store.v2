package io.github.gabriela.santiago31.fini.store.v2.validation.constraint.validation;

import io.github.gabriela.santiago31.fini.store.v2.validation.PhoneValidator;
import jakarta.validation.ConstraintValidator;
import jakarta.validation.ConstraintValidatorContext;

public class CustomPhoneValidator implements ConstraintValidator<PhoneValidator, String> {
